...
class LGL_Interpreter:
    ...
    def interpret_dictionary_erstellen(self, line: list) -> None:
        """This method creates dictionaries for the lgl and stores them in the self.dictionaries
    ...
    def interpret_dictionary_verbinden(self, line: list) -> None:
        """This method allows to merge two dictionaries. Either a new name is specified and both directories get merged

        there, or the second dictionary gets appended to the first.
