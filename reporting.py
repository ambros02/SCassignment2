...
class Reporter():
    ...
    def _present(self) -> None:
        ...
        print(
            f"| {'Function Name'.ljust(offset, ' ')}| {'Num. of calls'.ljust(offset, ' ')}| {'Total Time (ms)'.ljust(offset, ' ')}| {'Average Time (ms)'.ljust(offset, ' ')}|")
        print(
            f"|{''.ljust(offset + 1, '-')}|{''.ljust(offset + 1, '-')}|{''.ljust(offset + 1, '-')}|{''.ljust(offset + 1, '-')}|")
